...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Djoshcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"djoshcointools.com", "dnsseed.djoshcointools.com"},
    {"djoshcoinpool.org", "dnsseed.djoshcoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"djoshcointools.com", "testnet-seed.djoshcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Djoshcoin is probably already running."), addrBind.ToString().c_str());
        else
